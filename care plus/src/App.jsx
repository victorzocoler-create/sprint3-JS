...
export default function App() {
  ...
  const { state, toast, particles, showToast, redeemVoucher, carePet, doBattle, unlockedPowers } = gameState
  ...
  return (
    <>
      ...
      <div id="main" style={{ flex: 1, overflowY: 'auto', minHeight: 0 }}>
        ...
        {activeTab === 'missions' && <MissionsPage showToast={showToast} />}
        {activeTab === 'ranking'  && (
          <RankingPage
            showToast={showToast}
        ...
        {activeTab === 'profile'  && <ProfilePage  state={state} showToast={showToast} />}
